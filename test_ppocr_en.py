...
image_dir = "/data1/xyj/datasets/suzhou/images/ocr_en_422k"
...
if is_update:
    ...
    data = {'file_type':"images",'dir_name': image_dir.split("/")[-1],'task_name':"ocr_en"}
...
# 发起POST请求
url = 'http://10.10.81.31:5022/OCR_paddleOCR_en'  # 替换成实际的Docker服务端地址和端口号
